...
public class Cajero{
	...
	do{
		...
		if(usuario.equals("JARC") && contrasenia.equals("123")){
			System.out.println("Bienvenido Jose a su cuenta bancaria");
			...
			contrasenia = null;
				...
				}else if(usuario.equals("RAGO") && contrasenia.equals("123")){
			System.out.println("Bienvenido Raul a su cuenta bancaria");
			...
			contrasenia = null;
				...
				}else if(usuario.equals("BKMM") && contrasenia.equals("123")){
			System.out.println("Bienvenido Bryan a su cuenta bancaria");
